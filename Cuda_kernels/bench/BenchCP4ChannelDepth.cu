...
template<unsigned rank> void profile_helper(streambuf* output_buffer) {
  ...
  profile<1, 1, 512, 512, 1, 1, 3, 3, rank>(output_buffer);
  profile<1, 2, 512, 512, 1, 1, 3, 3, rank>(output_buffer);
  profile<1, 4, 512, 512, 1, 1, 3, 3, rank>(output_buffer);
  profile<1, 8, 512, 512, 1, 1, 3, 3, rank>(output_buffer);
  profile<1, 16, 512, 512, 1, 1, 3, 3, rank>(output_buffer);
  profile<1, 32, 512, 512, 1, 1, 3, 3, rank>(output_buffer);
  profile<1, 64, 512, 512, 1, 1, 3, 3, rank>(output_buffer);
  profile<1, 128, 512, 512, 1, 1, 3, 3, rank>(output_buffer);
}
