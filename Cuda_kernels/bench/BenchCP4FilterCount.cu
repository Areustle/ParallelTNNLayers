...
template<unsigned rank> void profile_helper(streambuf* output_buffer) {
  ...
  profile<1, 3, 512, 512, 1, 2,   3, 3, rank>(output_buffer);
  profile<1, 3, 512, 512, 1, 4,   3, 3, rank>(output_buffer);
  profile<1, 3, 512, 512, 1, 8,   3, 3, rank>(output_buffer);
  profile<1, 3, 512, 512, 1, 16,  3, 3, rank>(output_buffer);
  profile<1, 3, 512, 512, 1, 32,  3, 3, rank>(output_buffer);
  profile<1, 3, 512, 512, 1, 64,  3, 3, rank>(output_buffer);
  profile<1, 3, 512, 512, 1, 128, 3, 3, rank>(output_buffer);
}
