...
REGISTER_OP("MultiConv0Conv1Outer2")
    .Input("a: float")
    .Input("b: float")
    .Output("output: float")
    .Doc(R"doc(
Calculate the simultaneous multi-operation
    C = A (*^0_0 o *^1_1 o (x)^2_2) B
where A is a 3rd order Tensor and B is a 3rd order Tensor.
